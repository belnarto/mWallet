...
public class UserControllerTest {
    ...
    public void allUsersGet() throws Exception {
        ...
        mockMvc.perform(get("/users")
                ...
                .andExpect(model().attribute("users", hasItem(userService.findByLogin("Test2"))))
                .andReturn();
    ...
    public void addUserGet() throws Exception {
        mockMvc.perform(get("/users/addUser"))
                ...
                .andExpect(model().attribute("roles", hasItem(role)));
    }
    ...
    public void updateUserGetWithAdmin() throws Exception {
        ...
        mockMvc.perform(get("/users/" + userId + "/updateUser")
                .session(session))
                .andExpect(status().isOk())
                .andExpect(model().attribute("user", userService.findByLogin("Test2")))
